...
client_scripts {
    ...
    'chat/shared/*.lua', 
    'chat/client/*.lua', 
    'defaultevents/shared/*.lua', 
    'defaultevents/client/*.lua', 
  --  'blackscreen/shared/*.lua', 
   -- 'blackscreen/client/*.lua', 
    'mods/**/shared/*.lua',
    'mods/**/client/*.lua', 
...
server_scripts {
    ...
    'chat/shared/*.lua', -- Timer class
    'chat/server/*.lua', 
    'defaultevents/shared/*.lua', -- Timer class
    'defaultevents/server/*.lua', 
  --  'blackscreen/shared/*.lua', -- Timer class
   -- 'blackscreen/server/*.lua', 
    'mods/**/shared/*.lua',
    'mods/**/server/*.lua', 
    -- Load last
    'oof/shared/object-oriented/LOAD_ABSOLUTELY_LAST.lua'
...
files {
  ...
  --  'blackscreen/client/html/index.html',
    ...
    'mods/**/server/saved-files/windows-blocks.json',
    'mods/**/client/ui/style.css',
    'mods/**/client/ui/script.js',
    'mods/**/client/ui/index.html',
